 ...
 * Gmax force-field ring (mesh-style ring) and Gmax cloud clusters (vanilla smoke, dark red).
 */
object BetterLaprasParticles {
	...
	val GMAX_CLOUD_TRAIL_PUFF_ID: ResourceLocation =
		ResourceLocation.fromNamespaceAndPath("betterlapras", "gmax_cloud_trail_puff")

	@JvmField
	val GMAX_CLOUD_TRAIL_PUFF: SimpleParticleType = FabricParticleTypes.simple(true)
	...
	fun register() {
		...
		net.minecraft.core.Registry.register(BuiltInRegistries.PARTICLE_TYPE, GMAX_CLOUD_TRAIL_PUFF_ID, GMAX_CLOUD_TRAIL_PUFF)
	}
}
